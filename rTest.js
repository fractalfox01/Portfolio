...
window.addEventListener('scroll', function(){
    ...
    if(window.pageYOffset > 100 && flags[0]){
        flags[0] = true;
        flags[1] = true;
        console.log("here");
    ...
    if(window.pageYOffset > 200 && flags[1]){
        flags[1] = true;
        flags[2] = true;
        aa[0].style.marginLeft = "-100vw";
        aa[1].style.marginLeft = "1vw";
    }
    if(window.pageYOffset > 300 && flags[2]){
        flags[2] = true;
        flags[3] = true;
